...
class FinalBIMSystem:
    ...
    def _detect_construction_elements(self, content_text: str) -> Dict[str, List[tuple]]:
        """Detecta elementos de construcción en el texto"""
        elements = {
            "estructura": [],
            "arquitectura": [],
            "mep": [],
        ...
        # Palabras clave para detectar elementos
        keywords = {
            "estructura": {
                "columnas": ["columna", "pilar", "column"],
                "vigas": ["viga", "viga", "beam"],
                "losas": ["losa", "slab", "piso"],
                "muros": ["muro", "wall", "paramento"]
            },
            "arquitectura": {
                "muros_arquitectonicos": ["muro exterior", "paramento", "wall"],
                "puertas": ["puerta", "door", "portal"],
                "ventanas": ["ventana", "window", "abertura"]
            },
            "mep": {
                "instalaciones_electricas": ["electric", "cable", "circuito", "electricidad"],
                "instalaciones_sanitarias": ["sanitario", "plumbing", "desagüe", "agua"],
                "climatizacion": ["climatización", "hvac", "aire", "acondicionado"]
            },
            "civil": {
                "movimiento_suelos": ["excavación", "movimiento", "suelo", "terraplen"],
                "pavimentos": ["pavimento", "pavement", "asfalto", "hormigón"]
            }
        }
        
        content_lower = content_text.lower()
        
        # Detectar elementos basado en palabras clave
        for category, subcategories in keywords.items():
            for subcategory, words in subcategories